...
include('../dbConnection.php');
 ...
 if(isset($_REQUEST['courseSubmitBtn'])){
  ...
  if(($_REQUEST['course_name'] == "") || ($_REQUEST['course_desc'] == "") || ($_REQUEST['course_lecturer'] == "") || ($_REQUEST['course_price'] == "") || ($_REQUEST['course_original_price'] == "")){
   ...
   $course_lecturer = $_REQUEST['course_lecturer'];
   ...
   move_uploaded_file($course_image_temp, $img_folder);
    $sql = "INSERT INTO course (course_name, course_desc, course_lecturer, course_img,  course_price, course_original_price) VALUES ('$course_name', '$course_desc','$course_lecturer', '$img_folder',  '$course_price', '$course_original_price')";
...
<div class="col-sm-6 mt-5  mx-3 jumbotron">
  ...
  <form action="" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="course_lecturer" name="course_lecturer">
    </div>
