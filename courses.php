              ...
              echo ' 
                <div class="col-sm-4 mb-4">
                  <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align: left; padding:0px;"><div class="card">
                    ...
                    <p class="card-text d-inline">Price: <small><del>&#8360 '.$row['course_original_price'].'</del></small> 
                    <span class="font-weight-bolder">&#8360 '.$row['course_price'].'<span></p> <a class="btn btn-primary text-white 
