...
<head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      ...
      <img src="logo.jpeg" alt="logoimage" class="img-thumbnail " width="100" height="50">&nbsp;&nbsp; Samathvee</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <?php 
              ...
              if (isset($_SESSION['is_login'])){
                echo '<li class="nav-item custom-nav-item"><a href="student/studentProfile.php" class="nav-link">My Profile</a></li> ';
                    echo '<li class="nav-item custom-nav-item"><a href="checkMarks.php" class="nav-link">Marks</a></li> <li class="nav-item custom-nav-item"><a href="logout.php" class="nav-link">Logout</a></li>';
              } else {
          ...
          <li class="nav-item custom-nav-item"><a href="About Us" class="nav-link">About Us</a></li> <br>
        </ul>
      </div>
    </nav> <!-- End Navigation -->
