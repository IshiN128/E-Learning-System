 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2021 || Designed By Samathvee || <?php   
    ...
    if (isset($_SESSION['is_teacher_login'])){
      echo '<a href="teacher/teacherDashboard.php"> Teacher Dashboard</a> <a href="logout.php">Logout</a>';
    }else {
      echo '<a href="#login" data-toggle="modal" data-target="#teacherLoginModalCenter"> Teacher Login</a>';
    } ?>
  </small> 
  ...
  <div class="modal fade" id="teacherLoginModalCenter" tabindex="-1" role="dialog" aria-labelledby="teacherLoginModalCenterTitle" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="teacherLoginModalCenterTitle">Teacher Login</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" onClick="clearTeacherLoginWithStatus()">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form role="form" id="teacherLoginForm">
              <div class="form-group">
                <i class="fas fa-envelope"></i><label for="teacherLogEmail" class="pl-2 font-weight-bold">Email</label><input type="email"
                    class="form-control" placeholder="Email" name="teacherLogEmail" id="teacherLogEmail">
                </div>
                <div class="form-group">
                  <i class="fas fa-key"></i><label for="teacherLogPass" class="pl-2 font-weight-bold">Password</label><input type="password" class="form-control" 
                  placeholder="Password" name="teacherLogPass" id="teacherLogPass">
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <small id="statusTeacherLogMsg"></small>
            <button type="button" class="btn btn-primary" id="teacherLoginBtn" onclick="checkTeacherLogin()">Login</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal" onClick="clearTeacherLoginWithStatus()">Cancel</button>
          </div>
        </div>
      </div>
    </div> <!-- End Teacher Login Modal -->
    ...
    <!-- Teacher Ajax Call JavaScript -->
    <script type="text/javascript" src="js/teacherajaxrequest.js"></script>
